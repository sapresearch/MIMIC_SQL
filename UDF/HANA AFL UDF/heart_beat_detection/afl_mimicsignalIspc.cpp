...
#include "afl_mimicsignalWrapper.h"
...
{
    memcpy( &clsid, &mimicAFL_CLSID, sizeof(hana::AFLTech::AFLID) );
    memcpy( &iid,   &mimicAFL_IID,   sizeof(hana::AFLTech::AFLID) );
}
    ...
    char **         ppParamName )
{
    ...
    {
        (char*)"IN", 225, 0, 0, 0, 0, 1, 0, 0, 0, 0, (char*)"inputTable",
        (char*)"I/O", 226, 0,  0, 0, 0, 0, 0, 0, 0, 0, (char*)"I[IDS]+",
        (char*)"OUT", 225, 0, 0, 0, 0, 1, 0, 0, 0, 0, (char*)"outputTable",
        (char*)"I/O", 226, 0,  0, 0, 0, 0, 0, 0, 0, 0, (char*)"[IS]+"
    };
...
{
    1, (char*)"HEARTBEATDETECTION", 4, &Introspect_AppFunc1_Param, LFunc, var_columns, 0, &Introspect_AppFunc1_Prop, (char*)""
};
