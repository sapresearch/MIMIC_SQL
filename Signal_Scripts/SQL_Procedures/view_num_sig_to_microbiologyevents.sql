...
CREATE PROCEDURE view_num_sig_to_microbiologyevents (IN SIG_NAME VARCHAR(10), IN SUBJ_ID INTEGER) 
...
ELSE
	...
	END IF;
	EXEC 'CREATE VIEW "MIMIC2V26"."JOIN_NUM_SIG_' || :SIG_NAME || '_TO_MICROBIOLOGYEVENTS_FOR_' || :SUBJ_ID || '" AS (
		( SELECT
			"t"."SUBJECT_ID",
