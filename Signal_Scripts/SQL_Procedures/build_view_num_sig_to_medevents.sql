...
DROP PROCEDURE build_view_num_sig_to_medevents;
CREATE PROCEDURE build_view_num_sig_to_medevents (IN SIG_NAME VARCHAR(10)) 
	LANGUAGE SQLSCRIPT AS
	--DEFAULT SCHEMA "MIMIC2V26"
BEGIN
--EXEC 'DROP PROCEDURE view_num_sig_' || :SIG_NAME || '_to_medevents';
EXEC 'CREATE PROCEDURE view_num_sig_' || :SIG_NAME || '_to_medevents (IN SUBJ_ID INTEGER) 
	LANGUAGE SQLSCRIPT AS
	--DEFAULT SCHEMA "MIMIC2V26"
	BEGIN
