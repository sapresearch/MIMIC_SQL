...
BEGIN
	...
	SELECT COUNT(*) INTO table_exists FROM "TABLES" WHERE "SCHEMA_NAME" = CURRENT_SCHEMA AND "TABLE_NAME" = 'PAL_CLSTR_TIER2X_DATA_TBL' ;
	...
	WHILE :iteration_count <= :t1_cluster_count DO
		...
		EXECUTE IMMEDIATE 'CALL PAL_AP(PAL_CLSTR_TIER2X_DATA_TBL, PAL_AP_SEED_TBL, #PAL_CONTROL_TBL, PAL_AP_RESULTS_TIER2_' || :iteration_count || ') with OVERVIEW';
		EXECUTE IMMEDIATE 'DROP TABLE PAL_CLSTR_TIER2X_DATA_TBL';
